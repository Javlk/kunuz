...
def listview(request, tag_slug=None):
    ...
    last_news = Post.objects.filter(status ='active')[1:7]
    ...
    context={'maqolalar': posts, 'page':page, 'categories':categories, 'tag':tag, 'most_new':most_new,'last_news':last_news,'videos':videos}
